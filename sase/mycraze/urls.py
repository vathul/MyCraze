...
urlpatterns = patterns('',
	...
	url(r'^user-resume/(?P<user_id>\d+)$', UserView.get_resume_page, name='resume'),
	url(r'^my-work/(?P<user_id>\d+)$', UserView.get_my_work_page, name='my_work'),
	...
	url(r'^edit-profile-status/$', UserProfileView.edit_profile_status, name='edit_profile_status'),	
