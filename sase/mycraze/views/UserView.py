"""This module contains view classes pertaining to user - resume and my work
pages."""
...
def submit_profile(request):
    """This function handles user request to submit the profile completion
    form in the profile completion page and redirects the user to user resume
    page. 
    """
...
def edit_profile(request):
    """This function handles user request to edit his profile information and
    returns the json format of edited information. 
    """
...
def get_resume_page(request,user_id):
    """This function returns the resume page of the user with the id user_id. 
    If the user has no profile created, he is redirected to profile completion
    page. 
    """
...
def get_my_work_page(request,user_id):
    """This function returns the my work page of the user with the id user_id. 
    If the user has no profile created, he is redirected to profile completion
    page. 
    """
